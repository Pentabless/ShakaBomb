...
public class StageSelectDirector : MonoBehaviour
{
    ...
    private void UpdateSelectFrame(bool select)
    {
        ...
        if (select_stage == false)
        {
            ...
            {
                //始点…GameStartボタン
                start_button = go_stage[stage_number].transform;
                //終点…ExitGameボタン
                end_button = go_title_button.transform;
            }
            else
            {
                //始点…ExitGameボタン
                start_button = go_title_button.transform;
                //終点…GameStartボタン
                end_button = go_stage[stage_number].transform;
            }
